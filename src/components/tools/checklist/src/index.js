...
class Checklist {
  ...
  get CSS() {
    return {
      ...
      wrapper: 'sk_editor-checklist',
      item: 'sk_editor-checklist__item',
      itemChecked: 'sk_editor-checklist__item--checked',
      checkbox: 'sk_editor-checklist__item-checkbox',
      textField: 'sk_editor-checklist__item-text'
    };
  }
