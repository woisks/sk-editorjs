...
const CSS = {
    highlightingLine: 'sk_editor-toolbar',
    hidden: 'sk_editor-toolbar--hidden',
    horizontalToolBar: 'sk_editor-toolbar--hor',
    horizontalHighlightingLine: 'sk_editor-toolbar__shine-line--hor',
    verticalToolBar: 'sk_editor-toolbar--ver',
    verticalHighlightingLine: 'sk_editor-toolbar__shine-line--ver',
    plusButton: 'sk_editor-toolbar__plus',
    horizontalPlusButton: 'sk_editor-toolbar__plus--hor',
    verticalPlusButton: 'sk_editor-toolbar__plus--ver',
    area: 'sk_editor-table__area',
};
