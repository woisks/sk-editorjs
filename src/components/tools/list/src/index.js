...
class List {
    ...
    get CSS() {
        return {
            ...
            wrapper: 'sk_editor-list',
            wrapperOrdered: 'sk_editor-list--ordered',
            wrapperUnordered: 'sk_editor-list--unordered',
            item: 'sk_editor-list__item',
            settingsWrapper: 'sk_editor-list-settings',
